let tours_64 = [
    ...
    },
    {
      ...
      info: 'Lets go where classical music, towering castles, and the-hills-are-alive scenery welcome you to the gemütlichkeit of Bavaria and opulence of Austrias Golden Age. Your Rick Steves guide will bring th...',
      local_img: './img/vienna.jpg',
      price: 2695
    },
    {
      id: 4,
  ...
  const displayTours_64 = () => {
    const toursInfo = tours_64.map((tour) => {
